...
public class CalculationContext {
    ...
    public final boolean allowIceParkour;
    ...
    public CalculationContext(IBaritone baritone, boolean forUseOnAnotherThread) {
        ...
        this.playerHeight = Math.max(1, Baritone.settings().playerHeight.value);
        ...
        this.allowIceParkour = Baritone.settings().allowIceParkour.value;
        this.allowJumpAtBuildLimit = Baritone.settings().allowJumpAtBuildLimit.value;
        this.allowParkourAscend = Baritone.settings().allowParkourAscend.value;
        this.assumeWalkOnWater = Baritone.settings().assumeWalkOnWater.value;
        this.allowFallIntoLava = false; // Super secret internal setting for ElytraBehavior
        this.frostWalker = EnchantmentHelper.getEnchantmentLevel(baritone.getPlayerContext().player().registryAccess().lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.FROST_WALKER), baritone.getPlayerContext().player());
        ...
        int depth = EnchantmentHelper.getEnchantmentLevel(player.registryAccess().lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.DEPTH_STRIDER), player);
        if (depth > 3) {
            depth = 3;
        }
